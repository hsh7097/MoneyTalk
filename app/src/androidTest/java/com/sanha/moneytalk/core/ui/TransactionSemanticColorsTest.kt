...
class TransactionSemanticColorsTest {
    ...
    private fun verify(theme: ThemeMode) {
        compose.setContent {
            MoneyTalkTheme(themeMode = theme) {
                Column(
                    ...
                    HomeTheme {
                        HomeTransactionCard(fixture(3_400, income = true, excluded = true), {})
                        HomeTransactionCard(fixture(4_500, income = false, excluded = true), {})
        ...
        assertColor(won("5,600"), HomeColors.ExpenseOnGradient)
        assertColor(context.getString(R.string.home_income_badge, "6,700"), HomeColors.IncomeOnGradient)
    }
