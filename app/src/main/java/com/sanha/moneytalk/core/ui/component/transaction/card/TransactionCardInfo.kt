...
class ExpenseTransactionCardInfo(
    ...
    override val time: String = "${timeFormat.format(Date(expense.dateTime))} ${amPmFormat.format(Date(expense.dateTime)).uppercase()}"
...
class IncomeTransactionCardInfo(
    ...
    override val time: String = "${timeFormat.format(Date(income.dateTime))} ${amPmFormat.format(Date(income.dateTime)).uppercase()}"
}
