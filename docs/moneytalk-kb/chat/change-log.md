...
- 갱신한 문서: `README.md`, 루트 `../00-change-index.md`, `docs/CHAT_SYSTEM.md`, `docs/AI_CONTEXT.md`, `docs/ARCHITECTURE.md`, `docs/MONETIZATION.md`, `docs/CHANGELOG.md`
...
- 기준: `feature/chat/ui/ChatViewModel.kt`, `feature/chat/data/GeminiRepositoryImpl.kt`, `feature/chat/data/ChatRepositoryImpl.kt`, `core/util/DataQueryParser.kt`, `core/util/ChatCreditPolicy.kt`, `core/util/ChatContextBuilder.kt`, `docs/CHAT_SYSTEM.md`, `docs/AI_CREDIT_DEEP_ANALYSIS_PLAN.md`
