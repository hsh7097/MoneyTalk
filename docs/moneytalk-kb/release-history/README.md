---
type: package
title: Release History KB
description: MoneyTalk 변경 이력에서 아키텍처 판단에 필요한 큰 변화 축을 요약한다.
tags: [moneytalk, kb, changelog, release]
...
> 상태: draft
> 기준: 흡수된 릴리스 변경 이력 원문을 KB용 타임라인으로 재작성
...
| [04-release-1.0.5-readiness.md](04-release-1.0.5-readiness.md) | 23번 산출물·검증·브랜치 통합, 내부 출시와 운영·Alpha 심사 요청 | 1.0.5 제출 파일 식별과 Play 처리 상태·후속 확인 범위 |
