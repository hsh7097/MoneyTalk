...
| 토스/뱅크샐러드 벤치마크, 금융 UI, 화면 위계, 큰 글자, 공통 테마 | [project-context/05-finance-ui-design-system-20260908.md](project-context/05-finance-ui-design-system-20260908.md), [project-context/06-finance-ux-plan-20260908.md](project-context/06-finance-ux-plan-20260908.md), [project-context/07-finance-ui-validation-20260908.md](project-context/07-finance-ui-validation-20260908.md), [ui-map/01-screen-composable-index.md](ui-map/01-screen-composable-index.md), 영향 화면 rendering 문서 | 디자인 토큰·금액/상태 배치, 기획 교차 검토, 실행 로그와 실제 관찰 범위를 구분 |
...
| `app/src/main/java/com/sanha/moneytalk/feature/history/**` | [history/README.md](history/README.md), [history/00-structure-map.md](history/00-structure-map.md), [history/package-reference/README.md](history/package-reference/README.md) | 내역 화면, 활성 필터 재편집/별도 초기화, 큰 글자 달력, 상세/수정 진입 |
...
| `app/src/main/java/com/sanha/moneytalk/feature/weeklyevidence/**` | [home/package-reference/02-data-viewmodel.md](home/package-reference/02-data-viewmodel.md), [home/package-reference/03-rendering-action.md](home/package-reference/03-rendering-action.md) | 고정 제외 두 7일 소비 근거·기간 전환·기존 편집 |
| `app/src/main/java/com/sanha/moneytalk/feature/categoryreview/**` | [settings/package-reference/03-rendering-action.md](settings/package-reference/03-rendering-action.md), [settings/package-reference/05-menu-map.md](settings/package-reference/05-menu-map.md), [transaction-edit/README.md](transaction-edit/README.md) | 전체 기간 미분류 직접 확인, 설정 건수와 같은 노출 필터, 기존 거래 편집과 별도 자동 분류 |
...
| `SmsSyncResultFilter`, `StoredIncomeSourceRepairer` | [sms-parsing/06-ingestion-contract.md](sms-parsing/06-ingestion-contract.md), [sms-pipeline/README.md](sms-pipeline/README.md), [app-shell/README.md](app-shell/README.md) | 요청 월 저장 범위 필터와 기존 수입 출처 보정; MainViewModel에서 분리 |
...
| `app/src/main/java/com/sanha/moneytalk/core/appfunctions/**`, `MoneyTalkChatAppFunctionReader`, `MoneyTalkChatAppFunctionActionExecutor`, `MoneyTalkAppFunctionAnalyticsCalculator` | [app-functions/README.md](app-functions/README.md), [app-functions/06-function-catalog.md](app-functions/06-function-catalog.md), [app-functions/07-operational-playbook.md](app-functions/07-operational-playbook.md) | agent 기능 읽기/수정 노출, DB 점검 플레이북 |
