...
| 화면 | 핵심 요구 | 담당 KB |
|---|---|---|
| Home | 기존 중앙 월 이동·그라데이션 월 지출/수입, 바로 아래 누적 차트와 수집 안내, 예산 표시를 뺀 최근 소비 비교, 고정 예상·카테고리·오늘 전체 내역/합계/지출 건수, SMS/과거 월 CTA와 FAB | [home](../home/README.md), [home surface map](../home/package-reference/05-surface-map.md) |
