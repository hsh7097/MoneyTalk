...
| 날짜 | 근거 | 변경 | 영향 문서 | 메모 |
|---|---|---|---|---|
| 2026-09-08 | `TransactionDetailListScreen` 롱클릭 연결 확인 | 지출/수입 단건 수정/삭제 시트 진입 추가 | `package-reference/03-rendering-action.md` | 유형·ID를 보존하고 날짜/필터 유지 후 refresh를 확인. 저장 상세 계약은 transaction-mutation으로 연결. |
