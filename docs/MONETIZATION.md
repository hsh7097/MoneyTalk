...
| AI 채팅 상담 | **리워드 광고 시청 후** | 로컬 단순 조회는 없음, 상담/분석은 $0.01~0.03/회 |
...
- 상담/분석/비교/기간 해석이 필요한 질문은 여전히 Gemini 경로를 사용하므로 무료 채팅 횟수, 크레딧 비용, 질문 유형별 제한은 계속 관리 필요
- 무료 채팅 횟수를 일 1~2회로 줄이거나, 무료는 경량 모델(Flash-Lite) 사용 검토
