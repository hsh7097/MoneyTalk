...
└── TransactionEditScreen             ← 거래 편집 폼 (전체 화면)
    ├── OutlinedTextField (7개)       ← 금액/가게명/카테고리/결제수단/날짜/시간/메모
...
| 함수 | 설명 | 참조 |
|------|------|------|
| TransactionEditScreen | 거래 편집/추가 전체 화면 | [TransactionEditScreenKt](../app/src/main/java/com/sanha/moneytalk/feature/transactionedit/ui/TransactionEditScreen.kt) |
